...
async def test_all_endpoints():
    ...
    print(" took {} to complete impermanent_divergence_daily".format(get_timepassed_string(_startime)))

    _startime = dt.datetime.utcnow()
    await mainnet.impermanent_divergence_weekly()
    print(" took {} to complete impermanent_divergence_weekly".format(get_timepassed_string(_startime)))
    
    _startime = dt.datetime.utcnow()
    await mainnet.impermanent_divergence_monthly()
    print(" took {} to complete impermanent_divergence_monthly".format(get_timepassed_string(_startime)))
    
    _startime = dt.datetime.utcnow()    
    await mainnet.hypervisors_average_return()
    print(" took {} to complete hypervisors_average_return".format(get_timepassed_string(_startime)))
